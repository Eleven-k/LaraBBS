                                    ...
                                    <div class="post-item">
                                        ...
                                        <div class="post-item-userinfo">
                                            <a href="/post/HZ018V5E" class="">
                                                <div class="post-item-userinfo-avatar">
                                                    <img src="images/tim.jpg" alt="" class="post-item-userinfo-avatar-img">
                                                </div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="post-item-content">
                                            <div class="post-item-content-header">
                                                ...
                                                <span class="time">08-13 01:29</span>
                                                <span class="iconfont icon-zhiding"></span>
                                                <span class="iconfont icon-tupian"></span>
                                            </div>
                                            <div class="post-item-content-text">
                                                <a href="#">
                                                    <p>UBank - 领先的区块链支付解决方案。致力于为跨境电商等场景提供专业、安全、透明高效的支付能力。
                                                        产品基于USDT数字货币实现资产流通、支付闭环，同时应用内提供C2C闪兑、社区等能力，助您轻松玩转UBank。

                                                        UBank官方网站：https://ubank.cloud
                                                        UBank商户开放平台：https://open.ubank.cloud
                                                    </p>
                                                </a>
                                            </div>
